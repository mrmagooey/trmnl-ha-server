...
class TestIsDashboardVisible(unittest.TestCase):
    """Tests for is_dashboard_visible function."""
    
    def setUp(self):
        self.mock_logger = mock.Mock()
    
    def test_no_visibility_rules(self):
        """Test dashboard with no visibility rules is always visible."""
        dashboard = {'name': 'test'}
        now = datetime(2025, 1, 15, 12, 0)  # Wednesday
        
        result = is_dashboard_visible(dashboard, now, self.mock_logger)
    ...
    def test_single_day_match(self):
        ...
        dashboard = {
            'name': 'test',
            'visibility': {'days_of_the_week': 'Wednesday'}
        }
        now = datetime(2025, 1, 15, 12, 0)  # Wednesday
    ...
    def test_single_day_no_match(self):
        ...
        dashboard = {
            'name': 'test',
            'visibility': {'days_of_the_week': 'Monday'}
        }
        now = datetime(2025, 1, 15, 12, 0)  # Wednesday
    ...
    def test_day_range_match(self):
        ...
        dashboard = {
            'name': 'test',
            'visibility': {'days_of_the_week': 'Monday-Friday'}
        }
        now = datetime(2025, 1, 15, 12, 0)  # Wednesday
    ...
    def test_invalid_day_name(self):
        ...
        dashboard = {
            'name': 'test',
            'visibility': {'days_of_the_week': 'InvalidDay'}
        }
        now = datetime(2025, 1, 15, 12, 0)  # Wednesday
